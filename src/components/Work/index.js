...
import WorkspaceImage from "images/svg/workspace2.svg"
...
class Work extends Component {
  ...
  render() {
    ...
    return [
      <Jumbotron key='welcome' title='PUBLIC WORKSPACE' subtitle='where the magic happens' image={WorkspaceImage} onMount={this.onMount} />,
